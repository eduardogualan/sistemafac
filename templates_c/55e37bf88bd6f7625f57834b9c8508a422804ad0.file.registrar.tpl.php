                        ...
                        <ul class="nav nav-pills nav-justified steps">
                            ...
                            <li>
                                <a href="#tab2" data-toggle="tab" class="step">
                                    ...
                                    <span class="desc">
                                        <i class="fa fa-check"></i> Datos de Facturación </span>
                                </a>
                            </li>
                            <li>
...
" type="text" disabled="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  name="direccion"class="form-control col-md-7 col-xs-12" placeholder="ingrese la dirección de servicio" type="text">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                        <input id="valor_instalacion" name="valor_instalacion"class="form-control col-md-7 col-xs-12" placeholder="valor de instalación"type="text" onkeypress="return SoloNumerosDecimales(event, '0.0', 6, 2);">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                        <label class="control-label"> $</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Paga de Instalación *
                                        <span class="required">  </span>
                                    </label>
                                    <div class="col-md-4">
...
"><?php echo $_smarty_tpl->tpl_vars['datos']->value->nombre;?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="direccionIpWan" name="direccionIpWan"class="form-control col-md-7 col-xs-12" placeholder="ingrese la dirección ip wan"type="text" onkeyup="validacion('apellidos')">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="item form-group">
