<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-03-03 17:28:28
         compiled from "/var/www/indynet/application/views/templates/backend/factura/listar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:201733618956bfbc2e9e2492-69479297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f00eebec2a6d745d22a5aac247ba30dac12bc900' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/factura/listar.tpl',
      1 => 1456876243,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '201733618956bfbc2e9e2492-69479297',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56bfbc2eaf3c41_33887278',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56bfbc2eaf3c41_33887278')) {function content_56bfbc2eaf3c41_33887278($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
?>
                        <tr>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado=="Pendiente") {?>
                                    <td>
                                        <a class="btn btn-xs btn-danger" title="">Pendiente</a>
                                    </td>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado=="Pagado") {?>
                                    <td>
                                        <a href="<?php echo base_url();?>
facturas/generar-pdf/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_detalleMensualidad;?>
" class="btn btn-xs btn-success" title="Descargar Comprovante">Pagado</a>
                                    </td>
                            <?php }?>
...
<?php echo $_smarty_tpl->tpl_vars['datos']->value->fecha_vencimiento;?>
                            ...
                            <td><?php echo '$ ';?>
<?php echo $_smarty_tpl->tpl_vars['datos']->value->total_venta;?>
</td>
                            <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado=="Pendiente") {?>
                                    <td>S/F</td>
                            <?php }?>
