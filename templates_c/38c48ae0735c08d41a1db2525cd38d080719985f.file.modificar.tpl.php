<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-02-27 09:07:23
         compiled from "/var/www/indynet/application/views/templates/backend/cliente/modificar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1706071456aaff9d60f8f2-29698787%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38c48ae0735c08d41a1db2525cd38d080719985f' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/cliente/modificar.tpl',
      1 => 1454778831,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1706071456aaff9d60f8f2-29698787',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56aaff9d76d992_28337080',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56aaff9d76d992_28337080')) {function content_56aaff9d76d992_28337080($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
clientes/modificar-registro/<?php echo $_smarty_tpl->tpl_vars['obj']->value->id_persona;?>
" method="POST" autocomplete="off">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="cedula_ruc" name="cedula_ruc"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->cedula_ruc;?>
" type="text" onkeyup="validacion('cedula_ruc')" maxlength="13" onkeypress="return Solo_numeros(event)">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="apellidos" name="apellidos"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->apellidos;?>
"type="text" onkeyup="validacion('apellidos')"onkeypress="return Solo_letras(event)">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="nombres" name="nombres"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->nombres;?>
"type="text" onkeyup="validacion('nombres')"onkeypress="return Solo_letras(event)">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="telefono" name="telefono"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->telefono;?>
"type="text" onkeyup="validacion('telefono')"onkeypress="return Solo_numeros(event)">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="celular" name="celular"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->celular;?>
"type="text" onkeyup="validacion('celular')"onkeypress="return Solo_numeros(event)">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12  input-icon right">
                        <input id="email" name="email"class="form-control col-md-7 col-xs-12" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->email;?>
"type="text" onkeyup="validacion('email')">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-actions">
                            ...
                            <a href="<?php echo base_url();?>
clientes/listar"class="btn btn-danger pull-right"><i class="fa fa-close"></i> CANCELAR</a>
                        </div>
                    </div>
                </div>  
            </form>
