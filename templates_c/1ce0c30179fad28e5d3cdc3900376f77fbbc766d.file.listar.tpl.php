<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-12-07 06:08:57
         compiled from "C:\xampp\htdocs\indynet\application\views\templates\backend\usuario\listar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2863558479969aa6146-50526931%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ce0c30179fad28e5d3cdc3900376f77fbbc766d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\indynet\\application\\views\\templates\\backend\\usuario\\listar.tpl',
      1 => 1456960221,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2863558479969aa6146-50526931',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58479969d5f215_12091985',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58479969d5f215_12091985')) {function content_58479969d5f215_12091985($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
proformas" class="nav-link nav-toggle">
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="<?php echo base_url();?>
usuarios/registrar"class="btn btn-primary"><i class="fa fa-pencil"></i> NUEVO</a>
                <div class="btn-group">
...
<?php echo $_smarty_tpl->tpl_vars['datos']->value->persona->nombres;?>
                                    ...
                                    <td> <?php echo $_smarty_tpl->tpl_vars['datos']->value->persona->rol->nombre;?>
 </td>
                                   
                                    <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado=="1"&&$_smarty_tpl->tpl_vars['datos']->value->persona->rol->nombre!="Administrador") {?>
                                        <td>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-md-offset-3">
                                                                <div class="form-actions">
                                                                         <a href="<?php echo base_url();?>
usuarios/desactivar-cuenta/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_cuenta;?>
"class="btn btn-primary pull-left"><i class="fa fa-thumbs-up"></i> SI</a>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado=="0") {?>
                                        <td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-md-offset-3">
                                                                <div class="form-actions"> 
                                                                    <a href="<?php echo base_url();?>
usuarios/activar-cuenta/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_cuenta;?>
"class="btn btn-primary pull-left"><i class="fa fa-thumbs-up"></i> SI</a>
                                                                    <button type="button" class="btn btn-danger pull-right" data-dismiss="modal" ><i class="fa fa-close"></i> NO </button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-md-offset-3">
                                                                <div class="form-actions"> 
                                                                    <a href="<?php echo base_url();?>
usuarios/resetear-cuenta/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_cuenta;?>
"class="btn btn-primary pull-left"><i class="fa fa-thumbs-up"></i> SI</a>
                                                                    <button type="button" class="btn btn-danger pull-right" data-dismiss="modal" ><i class="fa fa-close"></i> NO </button>
                                                                </div>
                                                            </div>
