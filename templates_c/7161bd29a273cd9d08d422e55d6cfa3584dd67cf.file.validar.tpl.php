<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-01-28 13:51:54
         compiled from "/var/www/indynet/application/views/templates/backend/antena/validar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:137505665756aa155cca9693-13829274%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7161bd29a273cd9d08d422e55d6cfa3584dd67cf' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/antena/validar.tpl',
      1 => 1454007107,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '137505665756aa155cca9693-13829274',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56aa155cd5cce7_86465222',
  'variables' => 
  array (
    'titulo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_56aa155cd5cce7_86465222')) {function content_56aa155cd5cce7_86465222($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
administrador" class="nav-link ">
                       ...
                       <li class="nav-item  active open">
                            <a href="<?php echo base_url();?>
antena/listar" class="nav-link ">
                                <span class="title"><i class="fa fa-home"></i> Antenas</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="<?php echo base_url();?>
marcas-de-router/listar" class="nav-link ">
                                <span class="title"><i class="fa fa-home"></i> Marcas de Router</span>
                            </a>
                        </li>
    ...
    <div class="portlet light bordered" id="form_wizard_1">
        ...
        <div class="portlet-body form">
            <form onsubmit="return validar()" class="form-horizontal form-label-left" action="">
                <div class="form-body">

                    <h3 class="form-section">Validation States With Icons</h3>

                    <div class="form-group has-error">
                        <label class="control-label col-md-3">Error </label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">validar campo </label>
                        <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                            
                                <input type="text" class="form-control col-md-7 col-xs-12" id="nombre" onkeyup="validacion('nombre')"/> 
        ...
        function validacion(campo) {
            ...
            if (campo == 'nombre') {
                ...
                if (nombre == null || nombre.length == 0 || /^\s+$/.test(nombre)) {
                    ...
                    $('#' + campo).parent().append("<i id='i" + campo + "' class='fa fa-remove form-control-feedback'></i>");
                    return false;
                } else {
                    $("#i" + campo).remove();
                    $('#' + campo).parent().parent().attr("class", "form-group has-success has-feedback");
                    $('#' + campo).parent().children('span').hide();
                    $('#' + campo).parent().append("<i id='i" + campo + "' class='color-red fa fa-check form-control-feedback'></i>");
                    return true;
