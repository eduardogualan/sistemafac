<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-02-29 10:19:20
         compiled from "/var/www/indynet/application/views/templates/backend/planes/registrar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162958875356aaea6bf004b1-55707954%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29c744af48b1d102fa88e8b103d9ac764985d81d' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/planes/registrar.tpl',
      1 => 1454978238,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '162958875356aaea6bf004b1-55707954',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56aaea6c0db7e6_14932194',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56aaea6c0db7e6_14932194')) {function content_56aaea6c0db7e6_14932194($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
planes/guardar" method="POST" autocomplete="off">
...
"><?php echo $_smarty_tpl->tpl_vars['datos']->value->nombre;?>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6 input-icon right">
                        <input id="velocidad" name="velocidad"class="form-control col-md-7 col-xs-12" placeholder="velocidad"type="text" onkeypress="return SoloNumerosDecimales(event, '0.0', 6, 2);" onkeyup="validacion('velocidad')">
                        <span class="help-block"></span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6 input-icon right">
                        <input id="valor_mensual" name="valor_mensual"class="form-control col-md-7 col-xs-12" placeholder="valor mensual"type="text" onkeypress="return SoloNumerosDecimales(event, '0.0', 6, 2);" onkeyup="validacion('valor_mensual')">
                        <span class="help-block"></span>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
