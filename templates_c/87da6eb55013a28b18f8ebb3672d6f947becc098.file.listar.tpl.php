<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-12-07 06:09:25
         compiled from "C:\xampp\htdocs\indynet\application\views\templates\backend\contrato_plan\listar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15753584799852a7b92-32288719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87da6eb55013a28b18f8ebb3672d6f947becc098' => 
    array (
      0 => 'C:\\xampp\\htdocs\\indynet\\application\\views\\templates\\backend\\contrato_plan\\listar.tpl',
      1 => 1457052321,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15753584799852a7b92-32288719',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_584799854cf264_30558676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584799854cf264_30558676')) {function content_584799854cf264_30558676($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
proformas" class="nav-link nav-toggle">
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="<?php echo base_url();?>
contratar-plan/registrar"class="btn btn-primary"><i class="fa fa-pencil"></i> NUEVO</a>
                <div class="btn-group">
...
<?php echo " ";?>
<?php echo $_smarty_tpl->tpl_vars['datos']->value->apellidos;?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['datos']->value->nombre;?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['datos']->value->velocidad;?>
<?php echo " ";?>
<?php echo $_smarty_tpl->tpl_vars['datos']->value->descripcion;?>
</td>
                                <td><?php echo "$"." ";?>
<?php echo $_smarty_tpl->tpl_vars['datos']->value->valor_mensual;?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['datos']->value->nombre_canton;?>
<?php echo " - ";?>
<?php echo $_smarty_tpl->tpl_vars['datos']->value->nombre_parroquia;?>
</td>
                                <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado_contrato=="Activo") {?>
                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-md-offset-3">
                                                                <div class="form-actions"> 
                                                                    <a href="<?php echo base_url();?>
contratar-plan/desactivar/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_contrato;?>
"class="btn btn-primary pull-left"><i class="fa fa-thumbs-up"></i> SI</a>
                                ...
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['datos']->value->estado_contrato=="Inactivo") {?>
                                    <td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-md-offset-3">
                                                                <div class="form-actions"> 
                                                                    <a href="<?php echo base_url();?>
contratar-plan/activar/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_contrato;?>
"class="btn btn-primary pull-left"><i class="fa fa-thumbs-up"></i> SI</a>
                                                                    <button type="button" class="btn btn-danger pull-right" data-dismiss="modal" ><i class="fa fa-close"></i> NO </button>
                                                                </div>
                                                            </div>
                                ...
                                <td> 
                                    <a href="<?php echo base_url();?>
contratar-plan/modificar/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_contrato;?>
" class="btn btn-xs btn-success" title="Modificar"><i class="fa fa-pencil"></i></a>
                                        <?php if ($_smarty_tpl->tpl_vars['rol']->value=="Administrador") {?>
                                        <a href="<?php echo base_url();?>
contratar-plan/acuerdo-contrato-pdf/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_contrato;?>
" class="btn btn-xs btn-warning" title="Imprimir Acuerdo de Contrato"><i class="fa fa-file-pdf-o"></i></a>
                                        <a href="<?php echo base_url();?>
facturas/crear-manualmente/<?php echo $_smarty_tpl->tpl_vars['datos']->value->id_contrato;?>
" class="btn btn-xs btn-info" title="Crear Factura Manualmente"><i class="fa fa-money"></i></a>
                                        <?php }?>
                                </td>
                            </tr>
                        <?php } ?>
