<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-02-29 10:42:04
         compiled from "/var/www/indynet/application/views/templates/backend/factura/descuento_factura.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150571162556c66a2b1306a8-52767601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8baf9389a36547e30ea2ce17d48b3d1cac28fb20' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/factura/descuento_factura.tpl',
      1 => 1456429484,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '150571162556c66a2b1306a8-52767601',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56c66a2b229d36_90972479',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56c66a2b229d36_90972479')) {function content_56c66a2b229d36_90972479($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
?>
                <form  name="formCP"onsubmit="return validar()"class="form-horizontal form-label-left" action="<?php echo base_url();?>
facturas-descuento/modificar-registro<?php echo $_smarty_tpl->tpl_vars['obj']->value->id_detalleMensualidad;?>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>Cliente:</th>
                                            <th colspan="3"><?php echo $_smarty_tpl->tpl_vars['obj']->value->apellidos;?>
<?php echo " ";?>
<?php echo $_smarty_tpl->tpl_vars['obj']->value->nombres;?>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="3"><?php echo $_smarty_tpl->tpl_vars['obj']->value->nombre_canton;?>
<?php echo " - ";?>
<?php echo $_smarty_tpl->tpl_vars['obj']->value->nombre_parroquia;?>
</th>
                                        </tr>
                                        <tr>
                                            <th>Periodo de Consumo:</th>
                                            <th colspan="3"><strong>Desde: </strong><?php echo " ";?>
<?php echo $_smarty_tpl->tpl_vars['obj']->value->fecha_venta;?>
<?php echo "  ";?>
<strong>Hasta: </strong><?php echo "  ";?>
<?php echo $_smarty_tpl->tpl_vars['obj']->value->fecha_vencimiento;?>
</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" id="costoPlan"class="form-control col-md-7 col-xs-12"name="costoPlan" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->valor_mensual;?>
" readonly="readonly"></td>
                                        </tr>
                                        <tr>
                                            <td ><strong>Descuento</strong></td>
                                            <td><input type="text" id="DescuentoPlan"class="form-control col-md-7 col-xs-12"name="DescuentoPlan" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->valor_descuento;?>
" readonly="readonly"></td>
                                        </tr>
                                        <tr>
                                            <td ><strong>Subtotal</strong></td>
                                            <td><input type="text" id="valordeTotalPlan"class="form-control col-md-7 col-xs-12"name="valorTotalPlan" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->valor_total;?>
" readonly="readonly"></td>
                                        </tr>
                                        <tr>
                                            <td ><strong>Iva</strong></td>
                                            <td><input type="text" id="ivaPlan"class="form-control col-md-7 col-xs-12"name="ivaPlan" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->iva_venta;?>
" readonly="readonly"></td>
                                        </tr> 
                                        <?php if ($_smarty_tpl->tpl_vars['obj']->value->saldo_instalacion>0) {?>
                                            <tr>
                                                <td ><strong>Recrago de Instalación</strong></td>
                                                <td><input type="text" id="saldoPendiente"class="form-control col-md-7 col-xs-12"name="saldoPendiente" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->saldo_instalacion;?>
" readonly="readonly"></td>
                                            </tr>
                                        <?php }?>
                                        <?php if ($_smarty_tpl->tpl_vars['obj']->value->saldo_instalacion<=0) {?>
                                        <input type="hidden" id="saldoPendiente" name="saldoPendiente" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->saldo_instalacion;?>
">
                                    <?php }?>
                                    <tr>
                                        <td><strong>TOTAL</strong></td>
                                        <td><input type="text" id="totalPagar"class="form-control col-md-7 col-xs-12"name="totalPagar" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->total_venta;?>
" readonly="readonly"></td>
                                    </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url();?>
facturas-pendientes"class="btn btn-danger pull-right"><i class="fa fa-close"></i> CANCELAR</a>
                            </div>
                        </div>
                    </div>  
                </form>
