<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-03-03 22:17:11
         compiled from "/var/www/indynet/application/views/templates/backend/marca_router/modificar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51902987656a9b5cb6e8a31-77981185%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b189d92e1584761e01f5db38ba1e5d29b931271' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/marca_router/modificar.tpl',
      1 => 1456154036,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '51902987656a9b5cb6e8a31-77981185',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56a9b5cb78c694_04427872',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56a9b5cb78c694_04427872')) {function content_56a9b5cb78c694_04427872($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark bold uppercase">
                    MODIFICAR MARCA DE ROUTER
                </span>
            </div>
        </div>
        <div class="portlet-body form">
            <form   onsubmit="return validar()"class="form-horizontal form-label-left" action="<?php echo base_url();?>
marcas-de-router/modificar-registro/<?php echo $_smarty_tpl->tpl_vars['obj']->value->id_marcaRouter;?>
" method="POST" autocomplete="off">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="nombre" name="nombre"class="form-control col-md-7 col-xs-12" placeholder="nombre de antena"type="text"onkeyup="validacion('nombre')" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->nombre_marcaRouter;?>
">
