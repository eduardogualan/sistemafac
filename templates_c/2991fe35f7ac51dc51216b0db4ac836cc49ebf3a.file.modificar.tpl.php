<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-03-03 22:25:39
         compiled from "/var/www/indynet/application/views/templates/backend/tipos_planes/modificar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:48080010656aae497dae350-25735942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2991fe35f7ac51dc51216b0db4ac836cc49ebf3a' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/tipos_planes/modificar.tpl',
      1 => 1454778831,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '48080010656aae497dae350-25735942',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56aae497e80295_36482067',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56aae497e80295_36482067')) {function content_56aae497e80295_36482067($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark bold uppercase">
                    MODIFICAR TIPO DE PLAN
                </span>
            </div>
        </div>
        <div class="portlet-body form">
            <form   onsubmit="return validar()"class="form-horizontal form-label-left" action="<?php echo base_url();?>
tipos-de-planes/modificar-registro/<?php echo $_smarty_tpl->tpl_vars['obj']->value->id_tipoPlan;?>
" method="POST" autocomplete="off">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="nombre" name="nombre"class="form-control col-md-7 col-xs-12" placeholder="nombre de antena"type="text"onkeyup="validacion('nombre')" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->nombre;?>
">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-actions">
                            ...
                            <a href="<?php echo base_url();?>
tipos-de-planes/listar"class="btn btn-danger pull-right"><i class="fa fa-close"></i> CANCELAR</a>
                        </div>
                    </div>
                </div>   
            </form>
