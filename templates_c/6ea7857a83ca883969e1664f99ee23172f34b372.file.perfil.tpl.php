<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-03-02 20:41:09
         compiled from "/var/www/indynet/application/views/templates/backend/principal/perfil.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156849395456b7b019c94db3-69670684%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ea7857a83ca883969e1664f99ee23172f34b372' => 
    array (
      0 => '/var/www/indynet/application/views/templates/backend/principal/perfil.tpl',
      1 => 1455495121,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '156849395456b7b019c94db3-69670684',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_56b7b019d65d71_14766080',
  'variables' => 
  array (
    'titulo' => 0,
    'ci' => 0,
...
<?php if ($_valid && !is_callable('content_56b7b019d65d71_14766080')) {function content_56b7b019d65d71_14766080($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
...
assets/layouts/layout/img/perfil.png" />
                                </span>
                                <h4><strong>Usuario: </strong><?php echo $_smarty_tpl->tpl_vars['ci']->value->utilidades->Usuario('usuario');?>
</h4>
                            </div>
                            <div class="col-md-8">
                                <h4><strong>Rol: </strong><?php echo $_smarty_tpl->tpl_vars['rol']->value;?>
</h4>
                                <h4><strong>Nombre: </strong><?php echo $_smarty_tpl->tpl_vars['ci']->value->utilidades->Usuario('nombre');?>
</h4>
...
usuario/perfil-cambiar-contrasenia';
       $.ajax({
           type: 'POST',
           url: url1,
           data: 'valor=' + valor,
...
usuario/perfil-cambiar-contrasenia-guardar"; // El script a dónde se realizará la petición.
            $.ajax({
                type: "POST",
                url: url,
