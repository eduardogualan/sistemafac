...
{block name="contenido"}
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{base_url()}nodo/registrar"class="btn btn-primary"><i class="fa fa-pencil"></i> NUEVO</a>
                <div class="btn-group">
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {counter} </td>
                            <td> {$datos->nombre_nodoEnlazado} </td>
                            <td> 
                                <a href="{base_url()}nodo/modificar/{$datos->id_nodoEnlazado}" class="btn btn-xs btn-success" title="Modificar"><i class="fa fa-pencil"></i></a>
