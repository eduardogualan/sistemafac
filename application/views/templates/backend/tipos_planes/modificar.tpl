...
{block name="contenido"}
    <div class="portlet light bordered" id="form_wizard_1">
        ...
        <div class="portlet-body form">
            <form   onsubmit="return validar()"class="form-horizontal form-label-left" action="{base_url()}tipos-de-planes/modificar-registro/{$obj->id_tipoPlan}" method="POST" autocomplete="off">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="nombre" name="nombre"class="form-control col-md-7 col-xs-12" placeholder="nombre de antena"type="text"onkeyup="validacion('nombre')" value="{$obj->nombre}">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-actions">
                            ...
                            <a href="{base_url()}tipos-de-planes/listar"class="btn btn-danger pull-right"><i class="fa fa-close"></i> CANCELAR</a>
                        </div>
                    </div>
                </div>   
            </form>
