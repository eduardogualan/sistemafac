...
{block name="contenido"}
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{base_url()}tipos-de-planes/registrar"class="btn btn-primary"><i class="fa fa-pencil"></i> NUEVO</a>
                <div class="btn-group">
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {$datos->nombre} </td>
                            <td> 
                                <a href="{base_url()}tipos-de-planes/modificar/{$datos->id_tipoPlan}" class="btn btn-xs btn-success" title="Modificar"><i class="fa fa-pencil"></i></a>
