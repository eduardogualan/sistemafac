...
{block name="contenido"}
    <div class="portlet light bordered" id="form_wizard_1">
        ...
        <div class="portlet-body form">
            <form   onsubmit="return validar()"class="form-horizontal form-label-left" action="{base_url()}planes/guardar" method="POST" autocomplete="off">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="chosen-select form-control" id="tipoPlan" name="tipoPlan" onchange="validacion('tipoPlan')">
                            ...
                            {foreach from=$lista_tipoPlan item=datos}
                                <option value="{$datos->id_tipoPlan}">{$datos->nombre}</option>
                            {/foreach}
                        </select>
