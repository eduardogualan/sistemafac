...
{block name="contenido"}
    <div class="portlet light bordered" id="form_wizard_1">
        ...
        <div class="portlet-body form">
            <form   onsubmit="return validar()"class="form-horizontal form-label-left" action="{base_url()}clientes/modificar-registro/{$obj->id_persona}" method="POST" autocomplete="off">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="cedula_ruc" name="cedula_ruc"class="form-control col-md-7 col-xs-12" value="{$obj->cedula_ruc}" type="text" onkeyup="validacion('cedula_ruc')" maxlength="13" onkeypress="return Solo_numeros(event)">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-icon right">
                        <input id="telefono" name="telefono"class="form-control col-md-7 col-xs-12" value="{$obj->telefono}"type="text" onkeyup="validacion('telefono')"onkeypress="return Solo_numeros(event)">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="item form-group">
